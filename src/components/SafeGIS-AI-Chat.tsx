...
export default function SafeGISAIChat({ isVisible }: Props) {
  ...
  return (
    <div
      className={`absolute bottom-[18px] right-[109px] w-[400px] rounded-[15px] z-50 shadow-md origin-bottom-right
        ${
          isVisible
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
        ...
        />
        <p
          className="text-white opacity-70 text-[22px] font-semibold mt-[12px]"
          style={{ letterSpacing: "0.5px" }}
        >
          SafeGIS AI
        </p>
        <p
          className="text-[#C7C7C7] text-[15px] font-[400] mt-[8px] mb-[70px]"
