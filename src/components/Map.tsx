...
`;
  ...
  const addResourceMarker = (
    ...
    switch (type) {
      case "personnel":
        icon = <Users size={24} color="red" />;
        break;
      case "infrastructure":
        icon = <Building size={24} color="green" />;
        break;
      case "supplies":
        icon = <ShoppingBasket size={24} color="green" />;
        break;
      default:
        icon = <Users size={24} />;
    }
...
<label>Name:</label><br/>
<input type="text" id="res-name" value="${resourceData.name}" style="width:100%; marginbottom:6px;"/>
<label>Description:</label><br/>
<textarea id="res-desc" rows="3" style="width:100%;">${resourceData.description}</textarea>
</div>
<div style="margin-top:10px; display:flex; justify-content:space-between;">
<button id="save-btn" style="background:#5A5C99; color:white; padding:4px 8px; borderradius:4px;">Save</button>
<button id="delete-btn" style="background:#B33A3A; color:white; padding:4px 8px; borderradius:4px;">Delete</button>
</div>
</div>
`;
