...
import { hazardLayersData } from "./HazardLayersConfig";
...
export default function HazardMapControls({}: HazardMapControlsProps) {
  ...
  const filteredAndSortedData = hazardLayersData
    .filter(
      (item) =>
        item.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        item.hazardType.toLowerCase().includes(searchTerm.toLowerCase()) ||
